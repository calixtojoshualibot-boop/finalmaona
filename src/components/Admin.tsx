            ...
            allOrders.map(order => (
              <div key={order.id} className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
                <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                  <div>
                    <span className="text-[10px] font-black text-slate-400 uppercase">Customer: {order.userName}</span>
                     ...
                     <div className="bg-slate-50 p-4 rounded-lg flex flex-col justify-between">
                        <div className="flex gap-6 mb-4">
                           <div>
                              ...
                              <p className="text-sm font-bold uppercase text-red-600">{order.paymentMethod}</p>
                           </div>
                           <div>
                              <p className="text-[10px] font-black text-slate-400 uppercase">Type</p>
                              <p className="text-sm font-bold uppercase text-red-600">{order.deliveryType}</p>
                           </div>
                        </div>
                        <div className="flex justify-between items-end">
                           <span className="text-xs font-black text-slate-400 uppercase">Total Collected</span>
                           <span className="text-2xl font-black text-slate-900">₱{order.total.toLocaleString()}</span>
                        </div>
                     </div>
                  </div>
                </div>
